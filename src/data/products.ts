...
export const products: Product[] = [
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        body: 'Clips land in your TikTok drafts, captions written, ready to go. You tap publish. Nothing leaves without you.',
      },
    ],
    ...
    zones: [
      ...
      {
        eyebrow: '02 · The Ranking',
        headline: 'Sorted by who you killed. Not that you killed.',
        body: "Every kill arrives with a name attached, so the ordering can be about the opponent. Ended a pro? An org player? Someone live on Twitch right now? That row goes first, and the clip titles itself. A tool watching pixels cannot know who was on the other end of that shot — the information simply isn't on screen.",
        visual: {
          kind: 'chips',
          chips: [
      ...
      },
      {
        ...
        visual: {
          kind: 'chips',
          chips: [
            { label: 'Seek accuracy', value: 'no drift', emphasize: true },
            { label: 'Broadcast delay', value: 'auto-measured', emphasize: true },
            { label: 'Your VOD or your recording', value: 'both' },
          ],
          caption: 'Alignment · measured, not assumed',
        },
      },
      {
        eyebrow: '04 · The Delivery',
        headline: 'In your drafts. Before you read your texts.',
        body: "Each clip comes back as a 9:16 vertical with burned captions, a written hook, and hashtags — pushed straight to your TikTok drafts inbox. YouTube Shorts on request. For Reels we hand you the finished file to post yourself. You open your phone and tap publish. We never post for you, and we never will without you asking.",
        visual: {
          kind: 'chips',
          chips: [
            { label: 'TikTok · drafts inbox', value: 'live', emphasize: true },
            { label: 'YouTube Shorts', value: 'on request', emphasize: true },
            { label: 'Instagram Reels · file in hand', value: 'you post' },
          ],
          caption: 'Delivery · the publish button stays yours',
        },
      },
    ],
  },
  ...
  },
  {
    ...
    primaryCta: { label: 'Download for Chrome / Brave / Edge', href: 'https://dl.maxxtopia.com/adblockmaxxer-chrome-v1.6.3.zip', external: true },
  ...
  },
  {
    ...
    demoVideo: {
      src: '/screenshots/streammaxxing/demo-cut-trailer.mp4?v=3',
      src720: '/screenshots/streammaxxing/demo-cut-trailer-720.mp4?v=3',
      poster: '/screenshots/streammaxxing/demo-cut-trailer-poster.jpg?v=3',
    },
  },
  {
    slug: 'snipemaxxer',
    ...
    primaryCta: { label: 'Download for Windows', href: 'https://dl.maxxtopia.com/snipemaxxer/Snipemaxxer-Setup-0.1.71.exe', external: true },
