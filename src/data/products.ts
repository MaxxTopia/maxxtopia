...
export const products: Product[] = [
  ...
  },
  {
    ...
    secondaryCta: { label: 'Launch PC Web App', href: 'https://viewmaxxing.pages.dev', external: true },
    glyph: '◐',
  ...
  },
  {
    ...
    primaryCta: { label: 'Download for Chrome / Brave / Edge', href: 'https://dl.maxxtopia.com/adblockmaxxer-chrome-v1.6.10.zip', external: true },
