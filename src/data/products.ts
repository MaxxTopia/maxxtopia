...
export const products: Product[] = [
  ...
  },
  {
    ...
    secondaryCta: { label: 'Launch PC Web App', href: 'https://dtman-gif.github.io/viewmaxxing/', external: true },
    glyph: '◐',
  ...
  },
  {
    ...
    primaryCta: { label: 'Download for Chrome / Brave / Edge', href: 'https://dl.maxxtopia.com/adblockmaxxer-chrome-v1.6.6.zip', external: true },
