...
const PRODUCTS = [
  ...
  { slug: 'extensionmaxxing',    name: 'AdBlockMaxxer',       category: 'Browser Extension', status: 'soon', tagline: "The ad blocker they couldn't ban.", accent: '#00d4ff', stat: '0 ads · every browser' },
];
